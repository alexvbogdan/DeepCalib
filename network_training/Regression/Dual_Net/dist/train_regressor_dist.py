...
from utils_regressor_dist import RotNetDataGenerator, angle_error, CustomModelCheckpoint
...
with tf.device('/gpu:0'):
    ...
    model = Model(input=main_input, output=final_output_distortion)
    model.load_weights('logs/20180528-005731/model_multi_class/Best/weights_05_0.01.h5')
