...
class RotNetDataGenerator(object):
    ...
    def __data_generation(self, input,labels,num_classes_focal,num_classes_distortion):
        ...
        for index, current_input in enumerate(input):
            ...
            label_focal = to_categorical(int(labels[index]),num_classes_focal)
            batch_label_focal.append(label_focal)
            batch_label_distortion.append(input_dist)
        ...
        return {'main_input':batch_x, 'concat_input':batch_label_distortion}, batch_label_focal
